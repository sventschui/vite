...
exports.vueJsxFilePath = path_1.default.resolve(__dirname, 'vueJsxCompat.js')
const JsxPresets = {
  vue: { jsxFactory: 'jsx', jsxFragment: 'Fragment' },
  preact: { jsxFactory: 'h', jsxFragment: 'Fragment' },
  react: {} // use esbuild default
}
function reoslveJsxOptions(options = 'vue') {
...
exports.reoslveJsxOptions = reoslveJsxOptions
...
exports.transform = async (src, file, options = {}, jsxOption) => {
